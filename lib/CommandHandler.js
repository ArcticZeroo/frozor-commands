...
class CommandHandler {
    ...
    constructor(opts = {}) {
        ...
        this.formatter = Object.assign({
            nocommand: (msg, client, extra) => false,
    ...
    static instantiate(i, ...d) {
        ...
        if (typeof i === 'object') {
            ...
            if (Array.isArray(i)) {
                for (const e of i) {
                    const c = CommandHandler.instantiate(e, ...d);
    ...
    async populate (input, ...d) {
        ...
        // Don't really care what it is, try to let instantiate handle it.
        const commands = CommandHandler.instantiate(input, ...d);
